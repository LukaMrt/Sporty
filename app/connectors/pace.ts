import { CYCLING_SLUGS, SWIMMING_SLUGS, type SportySportSlug } from '#connectors/sport_slug'

/**
 * Allure normalisee Sporty : km/h pour le velo, min/100 m pour la natation,
 * min/km pour tout le reste.
 *
...
export function computeAllure(speedMs: number | null, sportSlug: SportySportSlug): number | null {
  ...
  if (SWIMMING_SLUGS.includes(sportSlug)) {
    return 100 / (speedMs * 60)
  }
