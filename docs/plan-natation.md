...
| #    | Tâche                                                                                                                                                                                                                                      |
| ---- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| A3.1 | **Spike** : interroger le serveur OW sur un workout de nage réel et lister les types de timeseries disponibles (coups de bras, longueurs, SWOLF, bassin ?). Documenter le résultat dans `types.ts`. La suite de A.3 dépend de ce résultat. |
